...
namespace CommonModule.Core.Auth;
    ...
    public class AuthService : IAuthService
    {
        ...
        public string GetCurrentToken()
        {
            ...
            return authorizationHeader.StartsWith("Bearer ") ? authorizationHeader.Substring("Bearer ".Length).Trim() : null;
        }
        ...
        {
            var userIdString = this.httpContextAccessor.HttpContext.User.FindFirst(ClaimTypes.NameIdentifier)?.Value;
